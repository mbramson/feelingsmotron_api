...
config :feelingsmotron,
  ecto_repos: [Feelingsmotron.Repo]

# Configures the endpoint
config :feelingsmotron, Feelingsmotron.Web.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "94tJaReWHmXpzPGLsX7LMi3UXD1WZwZB1L7+Zp/KL9YhspYx0NRpcjBrIJMfWi6Q",
  render_errors: [view: Feelingsmotron.Web.ErrorView, accepts: ~w(json)],
  pubsub: [name: Feelingsmotron.PubSub,
...
config :guardian, Guardian,
  ...
  serializer: Feelingsmotron.GuardianSerializer
