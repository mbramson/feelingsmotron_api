...
# FeelingsmotronWeb.Endpoint.load_from_system_env/1 dynamically.
...
config :feelingsmotron, FeelingsmotronWeb.Endpoint,
  on_init: {FeelingsmotronWeb.Endpoint, :load_from_system_env, []},
...
# start per endpoint:
#
#     config :feelingsmotron, FeelingsmotronWeb.Endpoint, server: true
#
